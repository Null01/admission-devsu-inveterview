package co.com.devsu.bank.client.config;
...
import co.com.devsu.bank.client.properties.DatabaseApplicationProperties;
...
@EnableJpaRepositories(
        ...
        basePackages = {"co.com.devsu.bank.client.model.repository"})
public class DatabasePersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean mainEntityManagerFactory(EntityManagerFactoryBuilder builder, @Qualifier("mainDataSourceExtension") DataSource dataSource) {
        return builder.dataSource(dataSource).packages("co.com.devsu.bank.client.model.entities").persistenceUnit("pu-ms-client").build();
    }
