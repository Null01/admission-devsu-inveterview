...
import co.com.devsu.bank.client.controllers.ClientRestController;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage(ClientRestController.class.getPackage().getName()))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("API-REST / MS-CLIENT",
